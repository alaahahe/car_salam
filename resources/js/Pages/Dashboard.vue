...
const columns = [
  { prop: "no", name: "No" },
  { prop: "car_owner", name: "Car owner" },
  { prop: "car_type", name: "Car type" },
  { prop: "year", name: "year" },
  { prop: "color", name: "color" },
  { prop: "vin", name: "VIN" },
  { prop: "car_number", name: "Car Number" },
  { prop: "dinar", name: "Dinar" },
  { prop: "dolar_price", name: "dolar price" },
  { prop: "dolar_custom", name: "Dolar custom" },
  { prop: "note", name: "Note" },
  { prop: "shipping_dolar", name: "Shipping dolar" },
  { prop: "coc_dolar", name: "COC dolar" },
  { prop: "checkout", name: "Checkout" },
  { prop: "all", name: "All" },
  { prop: "paid", name: "Paid" },
...
//     const gridComponent = $refs.grid;
//     console.log('Editing event:', gridComponent);

//   const rowIndex = event.detail.y;
//   const colIndex = event.detail.x;
//   const newValue = event.detail.model[columns[colIndex].prop];

//   // Update the value in your data source (rows)
//   rows.value[rowIndex][columns[colIndex].prop] = newValue;

//   // You can save the changes to a backend here if needed
//   saveChangesToBackend(rows.value[rowIndex]);
// };

// const saveChangesToBackend = (row) => {
//   // Simulated function to save changes to a backend
//   console.log('Saving changes to backend:', row);
// };
            ...
            <div class="bg-white overflow-hidden shadow-sm ">
                <div class="p-6  dark:bg-gray-900">
                    <div class="flex flex-col">
                      ...
                      <div>
                        <!-- <div>
                        <revo-grid  theme="compact" exporting="true" :source="rows" :columns="columns"  ref="grid"  style="height: 200px;direction: ltr;" @afterEdit="handleEdit" />
                        </div> -->
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7">     
                          <div class="flex items-start rounded-xl dark:bg-gray-600 dark:text-gray-300 bg-white p-4 shadow-lg">
                            ...
                            <div class="mr-4" >
                              ...
                              <p class="mt-2 text-sm text-gray-500 dark:text-gray-200">{{ mainAccount.wallet?.balance }}</p>
                            </div>
                          </div>
                          <!-- <div class="flex items-start rounded-xl dark:bg-gray-600 dark:text-gray-300 bg-white p-4 shadow-lg">
